...
if (
    ($stats != 'creator' && $stats != 'administrator' && $stats != 'member') &&
    ($stats2 != 'creator' && $stats2 != 'administrator' && $stats2 != 'member') &&
    ($stats3 != 'creator' && $stats3 != 'administrator' && $stats3 != 'member') &&
    ($stats4 != 'creator' && $stats4 != 'administrator' && $stats4 != 'member') &&
    is_file("lib/kodam/channel.txt") &&
    is_file("lib/kodam/channel2.txt") &&
    is_file("lib/kodam/channel3.txt") &&
    is_file("lib/kodam/channel4.txt") &&
    $chatID != $admin &&
    $Tc == 'private'
) {
    bot('sendMessage', [
        'chat_id' => $chatID,
        'text' => "🔐 کاربر گرامی؛ جهت ادامه کار در ربات و همچنین حمایت از سازنده ربات لطفا در کانال‌های زیر عضو شوید.
