...
'inline_keyboard'=>[
[['text' => "ست وب هوک 🍫", 'callback_data' => "set"],['text' => "حذف وبهوک 📛", 'callback_data' => "del"]],
[['text' => "اطلاعات توکن 🔎", 'callback_data' => "info"]],
[['text' => " دریافت آخرین خطاها ⚠️", 'callback_data' => "errrorrs"],['text'=> "پاکسازی آپدیت ها ♻️", 'callback_data' => "deleteror"]],
]]);
...
'inline_keyboard'=>[
[['text' => "حذف وبهوک 🗑️", 'callback_data' => "donedel"]],
]]);
...
[['text'=>"آمار ربات 📊"]],
[['text'=>"فوروارد همگانی ↪️"],['text'=>"ارسال همگانی 📬"]],
[['text'=>"حدف مسدودی ✅"],['text'=>"مسدود کردن ⛔️"]],
[['text'=>"برگشت 🔙"]]
