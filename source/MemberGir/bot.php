...
$chatID = $callback_query->message->from->id;
...
if(file_exists("lib/Button/comande1.txt")){
$comande1 = file_get_contents("lib/Button/comande1.txt");
}else{
$comande1 = "تنظیم نشده";
}
#========================================================#
if(file_exists("lib/Button/comande2.txt")){
$comande2 = file_get_contents("lib/Button/comande2.txt");
}else{
$comande2 = "تنظیم نشده";
}
#========================================================#
if(file_exists("lib/Button/comande3.txt")){
$comande3 = file_get_contents("lib/Button/comande3.txt");
}else{
$comande3 = "تنظیم نشده";
}
#========================================================#
if(file_exists("lib/Button/comande4.txt")){
$comande4 = file_get_contents("lib/Button/comande4.txt");
}else{
$comande4 = "تنظیم نشده";
}
#========================================================#
if(file_exists("lib/Button/comande5.txt")){
$comande5 = file_get_contents("lib/Button/comande5.txt");
}else{
$comande5 = "تنظیم نشده";
}
#========================================================#
if(file_exists("lib/Button/comande6.txt")){
$comande6 = file_get_contents("lib/Button/comande6.txt");
}else{
$comande6 = "تنظیم نشده";
}
#========================================================#
if(file_exists("lib/Button/comande7.txt")){
$comande7 = file_get_contents("lib/Button/comande7.txt");
}else{
$comande7 = "تنظیم نشده";
}
#========================================================#
if(file_exists("lib/Button/comande8.txt")){
$comande8 = file_get_contents("lib/Button/comande8.txt");
}else{
$comande8 = "تنظیم نشده";
}
#========================================================#
if(file_exists("lib/Button/comande9.txt")){
$comande9 = file_get_contents("lib/Button/comande9.txt");
}else{
$comande9 = "تنظیم نشده";
}
#========================================================#
if(file_exists("lib/Button/comande10.txt")){
$comande10 = file_get_contents("lib/Button/comande10.txt");
}else{
$comande10 = "تنظیم نشده";
}
#========================================================#
if(file_exists("lib/Button/comande11.txt")){
$comande11 = file_get_contents("lib/Button/comande11.txt");
}else{
$comande11 = "تنظیم نشده";
}
#========================================================#
#========================================================#
#========================================================#
if(file_exists("lib/Button/comande12.txt")){
$comande12 = file_get_contents("lib/Button/comande12.txt");
}else{
$comande12 = "✅";
}
#========================================================#
if(file_exists("lib/Button/comande22.txt")){
$comande22 = file_get_contents("lib/Button/comande22.txt");
}else{
$comande22 = "✅";
}
#========================================================#
if(file_exists("lib/Button/comande32.txt")){
$comande32 = file_get_contents("lib/Button/comande32.txt");
}else{
$comande32 = "✅";
}
#========================================================#
if(file_exists("lib/Button/comande42.txt")){
$comande42 = file_get_contents("lib/Button/comande42.txt");
}else{
$comande42 = "✅";
}
#========================================================#
if(file_exists("lib/Button/comande52.txt")){
$comande52 = file_get_contents("lib/Button/comande52.txt");
}else{
$comande52 = "✅";
}
#========================================================#
if(file_exists("lib/Button/comande62.txt")){
$comande62 = file_get_contents("lib/Button/comande62.txt");
}else{
$comande62 = "✅";
}
#========================================================#
if(file_exists("lib/Button/comande72.txt")){
$comande72 = file_get_contents("lib/Button/comande72.txt");
}else{
$comande72 = "✅";
}
#========================================================#
if(file_exists("lib/Button/comande82.txt")){
$comande82 = file_get_contents("lib/Button/comande82.txt");
}else{
$comande82 = "✅";
}
#========================================================#
if(file_exists("lib/Button/comande92.txt")){
$comande92 = file_get_contents("lib/Button/comande92.txt");
}else{
$comande92 = "✅";
}
#========================================================#
if(file_exists("lib/Button/comande102.txt")){
$comande102 = file_get_contents("lib/Button/comande102.txt");
}else{
$comande102 = "✅";
}
#========================================================#
if(file_exists("lib/Button/comande112.txt")){
$comande112 = file_get_contents("lib/Button/comande112.txt");
}else{
$comande112 = "✅";
}
#========================================================#
if(file_exists("lib/Button/comande122.txt")){
$comande122 = file_get_contents("lib/Button/comande122.txt");
}else{
$comande122 = "✅";
}
#========================================================#
if(file_exists("lib/Button/helptext1.txt")){
$helptext1 = file_get_contents("lib/Button/helptext1.txt");
}else{
$helptext1 = "متن راهنما باید در پنل مدیریت تنظیم شود.";
}
//=====================================================
...
[['text'=>"📊 | آمار ربات •"],['text'=>"💬 | بخش پیام •"]],
[['text'=>"💠 | بخش دکمه ها •"],['text'=>"❄️ | تکمیل سفارش •"]],
[['text'=>"🔖 | تغییر پنل کاربر •"],['text'=>"⚡ | مبادلات $money •"]],
[['text'=>"🎉 | کد هدیه •"],['text'=>"✨ | بخش سفارشات •"]],
[['text'=>"💢 | تنظیمات پنل ها •"],['text'=>"🧑‍💻 | بخش ادمین •"]],
[['text'=>"🆔 | آیدی یاب •"],['text'=>"📝 | تنظیم متن ها •"]],
[['text'=>"🏆 | برترین اعضا •"],['text'=>"🛍 | بخش فروشگاه •"]],
[['text'=>"⚠️ | بخش اخطار •"],['text'=>"♨️ | تنظیمات زیرمجموعه •"]],
[['text'=>"✅ کسر اخطار"]],
[['text'=>"📣 | تنظیمات کانال •"],['text'=>"☯️ | پیگیری کاربر •"]],
[['text'=>"📚 | راهنـما •"],['text'=>"♻️ | بروزرسانی •"]],
[['text'=>"📌 | تنظیمات لغو سفارش •"],['text'=>"$icmoney تنظیمات انتقال $money"]],
...
//################دریافت الماس رایگان##########################
elseif($msg == "$dok1" or $msg == "$comande1" and $Tc == 'private'){
if ($comande12 == "✅"){
$user['step'] = 'none';
saveJson("melat/$userID.json",$user);
bot('sendMessage',[
...
bot('sendMessage',[
'chat_id'=>$chatID,
'text'=>"این بخش توسط مدیریت خاموش شده است 📛",
]);
}}
//################الماس روزانه#############################
...
//##############حساب کاربری######################################
elseif($msg == "$dok2" or $msg == "$comande2" and $Tc == 'private'){
if ($comande22 == "✅"){
$user['step'] = 'none';
saveJson("melat/$userID.json",$user);
if($user['type-panel'] == 'عادی'){
...
//#######################ثبت سفارش############################
else if($msg == "$dok3" or $msg == "$comande3" and $Tc == 'private'){
if ($comande32 == "✅"){
...
//#####################زیرمجموعه گیری################################
elseif($msg=="$dok4" or $msg == "$comande4" and $Tc == 'private'){
if ($comande42 == "✅"){
bot('sendMessage',[
'chat_id'=>$chatID,
'text'=>"
...
//######################بانگ انتقال########################################
elseif($msg == "$dok5" or $msg == "$comande5" and $Tc == 'private'){
if ($comande52 == "✅"){
$user['step'] = 'none';
saveJson("melat/$userID.json",$user);
bot('sendMessage',[
...
//###############بخش پیگیری####################################
elseif($msg == "$dok6" or $msg == "$comande6" and $Tc == 'private'){
if ($comande62 == "✅"){
bot('sendMessage',[
'chat_id'=>$chatID,
'text'=>"$doktxt6",
...
'reply_markup' => json_encode([
'inline_keyboard' => [
[["text"=>"🔙 بازگشت", 'callback_data' => "backpaybutton"]],
]])]);}}
//##########################################################################
...
'reply_markup' => json_encode([
'inline_keyboard' => [
[['text'=>"ارتباط با پشتیبانی 🚀",'url'=>"https://t.me/$suuuppoorttt"]],
[["text"=>"➡️ بازگشت", 'callback_data' => "backpaybutton"]],
]])]);
}
//###############ارتقا پنل################################
elseif($msg == "$dok7" or $msg == "$comande7" and $Tc == 'private'){
if ($comande72 == "✅"){
bot('sendMessage',[
'chat_id'=>$chatID,
'text'=>"$doktxt7",
...
//##################برترین عا#############################
elseif($msg == "$dok8" or $msg == "$comande8" and $Tc == 'private'){
if ($comande82 == "✅"){
bot('sendmessage',[
'chat_id'=>$chatID,
'text'=>"$doktxt8",
...
//###############فروشگاه##################################
elseif($msg == "$dok9" or $msg == "$comande9" and $Tc == 'private'){
if ($comande92 == "✅"){
if($user['phone'] != null){
...
//########################کد هدیه####################################
elseif($msg == "$dok11" or $msg == "$comande11" and $Tc == 'private'){
if ($comande12 == "✅"){
$user["step"] = "none";
saveJson("melat/$userID.json",$user);
bot('sendMessage',[
...
elseif($msg == "/help" and $Tc == 'private'){
if ($comande122 == "✅"){
$user["step"] = "none";
saveJson("melat/$userID.json",$user);
bot('sendMessage',[
...
🔰 قوانین سفارش دهنده ها :
⛔️ موجودی شما نباید منفی شود درصورت منفی شدن تمامی سفارشات شما تعلیق خواهند شد
⛔️ کانال یا گروه شما نباید شامل موارد زیر باشد:
➖ ربات نباید از ادمین بودن خارج شود
➖ خلاف قوانین جمهوری اسلامی ایران
➖  فحاشی و توهین
➖ محتوای جنسی و بزرگسالان
➖ مزاحمت و پخش اطلاعات افراد
➖ کلاهبرداری و پخش موارد جعلی
➖ تبلیغ ربات های مشابه، ربات های غیرواقعی
➖ فریب افراد و کاربران

⚠️ توجه داشته باشید در صورتی که کانال شما شامل موارد بالا باشد سفارش آن لغو و الماس های آن نیز برگشت داده نمی شود⚠️

کیفیت ، اصالت ، کارایی ، تعهد و سرعت",
'parse_mode' => "html",
'reply_markup' => json_encode([
'inline_keyboard' => [
[["text"=>"🔙 بازگشت", 'callback_data' => "backpaybutton"]],
...
//################ثبت سفارس شیشه ای##########################################
elseif(preg_match('/^memsabt-(.*)-(.*)/', $step, $match) and $text != "$back" and $text != "/help"){
$text = strtolower($text);
$text = str_replace('@', '', $text);
$text = str_replace('https://', '', $text);
$text = str_replace('http://', '', $text);
$text = str_replace('telegram.me/', '', $text);
...
$channels255 = json_decode(file_get_contents("https://api.telegram.org/bot$tokens_bot/getChatMember?chat_id=@$text&user_id=$id_adady"));
$channels2553 = json_decode(file_get_contents("https://api.telegram.org/bot$tokens_bot/getChat?chat_id=@$text"));
...
$dokc0 = str_replace('MEMBEROZV',$al,$dokc0);
}else{$dokc0 = "👤 سفارش ممبر جدید 👤";}
if ($keyboard_ch ==  1){
...
file_put_contents("photos/$text.jpg",$piclink);
$post_id = bot('SendPhoto', [
'chat_id' =>"@$chads",
'photo' =>new CURLFile("photos/$text.jpg"),
'caption' => "
‼️نام کانال : $descch1
...
'message_id'=>$msg_txt, 
'text'=>"
❌ربات @$boter_id ادمین کانال @$text نیست
...
//#########################################################
elseif($msg == "💠 | بخش دکمه ها •" and $Tc == 'private' and in_array($chatID,$list['admins'])){
bot('sendMessage',[
'chat_id'=>$chatID,
...
[["text" => "$dok0", 'callback_data' => "sets-dok0"],["text" => "$dok11", 'callback_data' => "sets-dok11"]],
[["text" => "🔷 تنظیمات نام دکمه های کانال 🔷", 'callback_data' => "0"]],
[["text" => "تعداد نمایش ممبر های سفارش 👤", 'callback_data' => "sets-dokc0"],["text" => "$dokc2", 'callback_data' => "sets-dokc2"]],
[["text" => "$dokc1", 'callback_data' => "sets-dokc1"],["text" => "$dokc3", 'callback_data' => "sets-dokc3"],["text" => "$dokc4", 'callback_data' => "sets-dokc4"]],
[["text" => "📍 تنظیم وضعیت و کامند برای دکمه های منو اصلی 📍", 'callback_data'=> "setcomandch"]],
[["text" => "🔘طرح دکمه های کانال🔘", 'callback_data' => "taeh_dokc"],["text" => "🔘چینش دکمه های ربات🔘", 'callback_data' => "chinesh_home"]],
[["text" => "🪙 تنظیمات برخی از دریافت امتیاز های ربات 💸", 'callback_data'=> "setemtiaz"]],

]])]);}

elseif($data == "setemtiaz"){
$user['step'] = 'none';
saveJson("melat/$userID.json",$user);
$data_left = json_decode(file_get_contents("lib/kodam/data-left.json"),true);
bot('editmessagetext', [
...
'message_id' => $msg_id,
'text'=>"
به بخش تنظیم برخی امتیاز های ربات خوش آمدید جهت تغییر امتیاز ها بروی دکمه های زیر کلیک کنید 💵
",
'parse_mode'=>'HTML',
'reply_markup' => json_encode([
'inline_keyboard' => [
[['text'=>"🪙 تنظیمات آیتم های تغییر امتیاز های بخش ها 🪙",'callback_data'=>"0"]],
[['text'=>"نام بخش",'callback_data'=>"0"],['text'=>"تعداد فعلی",'callback_data'=>"0"]],
[['text'=>"امتیاز ورود",'callback_data'=>"0"],['text'=>"$logincoin",'callback_data'=>"emtiazet-logincoin"]],

]])]);
}

elseif(preg_match('/^emtiazet-(.*)/', $data, $match)){
$dok = $match[1];
...
'reply_markup' => json_encode([
'inline_keyboard' => [
[["text"=>"🔙 بازگشت", 'callback_data' => "setemtiaz"]],
]])]);
}
//###################################################################
...
'message_id' => $msg_id,
'text'=>"
به بخش تنظیمات کامند گذاری و تنظیم وضعیت دکمه ها خوش امدید🌹


✅با استفاده از ستون مربوط به کامند میتوانید کامند های مورد نیاز خود را برای هر دکمه ایجاد نمایید

👈جهت ایجاد کامند ابتدا وارد @botfather شوید سپس دستور /mybots را بزنید و ربات خود را انتخاب نمایید
سپس با دکمه Edit commands  میتوانید کامند برای ربات خود ایجاد کنید 
به طور مثال با ایجاد دستور زیر

start - شروع مجدد

وقتی کاربر حرف / رو در رباتتون تایپ کند لیست دستورات شما به نمایش گذاشته میشود

پس از تنظیم کامند در @botfather ، از همین بخش کامندی که در @botfather ایجاد کردید را برای دکمه مورد نظر نیز ایجاد کنید

",
'parse_mode'=>'HTML',
'reply_markup' => json_encode([
'inline_keyboard' => [
[['text'=>"📍 تنظیمات آیتم های فعال سازی کامند های دکمه ها 📍",'callback_data'=>"0"]],
[['text'=>"نام دکمه",'callback_data'=>"0"],['text'=>"کامند",'callback_data'=>"0"],['text'=>"وضعیت",'callback_data'=>"0"]],
[['text'=>"/help",'callback_data'=>"0"],['text'=>"$comande122",'callback_data'=>"setvaz-comande122"]],
[['text'=>"$dok1",'callback_data'=>"0"],['text'=>"$comande1",'callback_data'=>"setcom-comande1"],['text'=>"$comande12",'callback_data'=>"setvaz-comande12"]],
[['text'=>"$dok2",'callback_data'=>"0"],['text'=>"$comande2",'callback_data'=>"setcom-comande2"],['text'=>"$comande22",'callback_data'=>"setvaz-comande22"]],
[['text'=>"$dok3",'callback_data'=>"0"],['text'=>"$comande3",'callback_data'=>"setcom-comande3"],['text'=>"$comande32",'callback_data'=>"setvaz-comande32"]],
[['text'=>"$dok4",'callback_data'=>"0"],['text'=>"$comande4",'callback_data'=>"setcom-comande4"],['text'=>"$comande42",'callback_data'=>"setvaz-comande42"]],
[['text'=>"$dok5",'callback_data'=>"0"],['text'=>"$comande5",'callback_data'=>"setcom-comande5"],['text'=>"$comande52",'callback_data'=>"setvaz-comande52"]],
[['text'=>"$dok6",'callback_data'=>"0"],['text'=>"$comande6",'callback_data'=>"setcom-comande6"],['text'=>"$comande62",'callback_data'=>"setvaz-comande62"]],
[['text'=>"$dok7",'callback_data'=>"0"],['text'=>"$comande7",'callback_data'=>"setcom-comande7"],['text'=>"$comande72",'callback_data'=>"setvaz-comande72"]],
[['text'=>"$dok8",'callback_data'=>"0"],['text'=>"$comande8",'callback_data'=>"setcom-comande8"],['text'=>"$comande82",'callback_data'=>"setvaz-comande82"]],
[['text'=>"$dok9",'callback_data'=>"0"],['text'=>"$comande9",'callback_data'=>"setcom-comande9"],['text'=>"$comande92",'callback_data'=>"setvaz-comande92"]],
[['text'=>"$dok0",'callback_data'=>"0"],['text'=>"$comande10",'callback_data'=>"setcom-comande10"],['text'=>"$comande102",'callback_data'=>"setvaz-comande102"]],
[['text'=>"$dok11",'callback_data'=>"0"],['text'=>"$comande11",'callback_data'=>"setcom-comande11"],['text'=>"$comande112",'callback_data'=>"setvaz-comande112"]],
]])]);
}

elseif(preg_match('/^setvaz-(.*)/', $data, $match)){
$textvazeeate = file_get_contents("lib/Button/$match[1].txt");
if($textvazeeate == "❌"){
Save("lib/Button/$match[1].txt","✅");
}else{
Save("lib/Button/$match[1].txt","❌");
}
saveJson("melat/$userID.json",$user);
...
'reply_markup' => json_encode([
'inline_keyboard' => [
[["text"=>"🔙 بازگشت", 'callback_data' => "setcomandch"]],

]])]);
$user['step'] = "none";
}

elseif(preg_match('/^setcom-(.*)/', $data, $match)){
$dok = $match[1];
$user['step'] = "setcom-$dok";
saveJson("melat/$userID.json",$user);
bot('editmessagetext', [
'chat_id' => $chatID,
'message_id' => $msg_id,
'text'=>"
کامند مورد نظرتو ارسال کن 📍
...
//###################################################################
elseif(preg_match('/^setcom-(.*)/', $step, $match)){
$user['step']= 'none';
$doke = $match[1];
Save("lib/Button/$doke.txt",$msg);
bot('sendmessage',[
...
//#########################################################
elseif($msg == "📝 | تنظیم متن ها •" and $Tc == 'private' and in_array($chatID,$list['admins'])){
bot('sendMessage',[
'chat_id'=>$chatID,
...
'reply_markup' => json_encode([
'inline_keyboard' => [
[["text" => "متن استارت", 'callback_data' => "setmm-starttext"]],
[["text" => "🔷 تنظیمات متن دکمه های ربات 🔷", 'callback_data' =>"0"]],
[["text" => "$dok1", 'callback_data' => "setmm-doktxt1"]],
[["text" => "$dok2", 'callback_data' => "setmm-doktxt2"],["text" => "$dok3", 'callback_data' => "setmm-doktxt3"]],
[["text" => "$dok6", 'callback_data' => "setmm-doktxt6"],["text" => "$dok7", 'callback_data' => "setmm-doktxt7"]],
[["text" => "$dok5", 'callback_data' => "setmm-doktxt5"],["text" => "$dok8", 'callback_data' => "setmm-doktxt8"]],
[["text" => "$dok0", 'callback_data' => "setmm-doktxt0"],["text" => "$dok11", 'callback_data' => "setmm-doktxt11"]],
]])]);}
//###################################################################
//#########################################################
elseif($msg == "✅ | بلاک و آنبلاک کردن | 📛" and $Tc == 'private' and in_array($chatID,$list['admins'])){
bot('sendMessage',[
'chat_id'=>$chatID,
...
//#########################################################
else if($msg == '🛍 | بخش فروشگاه •' and $Tc == 'private' and in_array($chatID,$list['admins'])){
$user['step'] = 'none';
...
//============================================================================//
elseif($msg == "💢 | تنظیمات پنل ها •" and $Tc == 'private' and in_array($chatID,$list['admins'])){
bot('sendMessage',[
'chat_id'=>$chatID,
...
//----------------------------------------------------------------------
elseif($msg == "🔙بازگشت به منو" or $msg == "👤 | پنل مدیریت ربات | 👤" and $Tc == 'private' and in_array($chatID,$list['admins'])){
$user['step'] = 'none';
saveJson("melat/$userID.json",$user);
bot('sendMessage',[
'chat_id'=>$chatID,
...
'reply_markup' => json_encode([
'inline_keyboard' => [
[["text"=>"🔙 بازگشت", 'callback_data' => "backbuttons"]],
]])]);
}
//###################################################################
...
'reply_markup' => json_encode([
'inline_keyboard' => [
[["text"=>"🔙 بازگشت", 'callback_data' => "backpanels"]],
]])]);
}
//###################################################################
elseif(preg_match('/^panels-(.*)/', $step, $match)){
...
'reply_markup' => json_encode([
'inline_keyboard' => [
[["text" => "متن استارت", 'callback_data' => "setmm-starttext"],["text" => "متن بنر زیرمجموعه", 'callback_data' => "setmm-zirtext"]],
[["text" => "🔷 تنظیمات متن دکمه های ربات 🔷", 'callback_data' =>"0"]],
[["text" => "$dok1", 'callback_data' => "setmm-dok1"]],
[["text" => "$dok2", 'callback_data' => "setmm-dok2"],["text" => "$dok3", 'callback_data' => "setmm-dok3"]],
[["text" => "$dok4", 'callback_data' => "setmm-dok4"],["text" => "$dok5", 'callback_data' => "setmm-dok5"]],
[["text" => "$dok6", 'callback_data' => "setmm-dok6"],["text" => "$dok7", 'callback_data' => "setmm-dok7"]],
[["text" => "$dok8", 'callback_data' => "setmm-dok8"],["text" => "$dok9", 'callback_data' => "setmm-dok9"]],
[["text" => "$dok0", 'callback_data' => "setmm-dok0"],["text" => "$dok11", 'callback_data' => "setmm-dok11"]],
]])]);
}
//###################################################################
elseif(preg_match('/^setmm-(.*)/', $data, $match)){
$dok = $match[1];
$user['step'] = "setmm-$dok";
saveJson("melat/$userID.json",$user);
bot('editmessagetext', [
...
'reply_markup' => json_encode([
'inline_keyboard' => [
[["text"=>"🔙 بازگشت", 'callback_data' => "backtexts"]],
]])]);
}
//###################################################################
elseif(preg_match('/^setmm-(.*)/', $step, $match)){
$user['step']= 'none';
$doke = $match[1];
Save("lib/Button/$doke.txt",$msg);
bot('sendmessage',[
...
//################################################################
if($msg == "✨ | بخش سفارشات •" and $Tc == 'private' and in_array($chatID,$list['admins'])){
$data_ads = json_decode(file_get_contents("lib/kodam/data-ads.json"),true);
bot('sendmessage',[
'chat_id'=>$chatID,
...
[['text'=>"فیلم یا متن اموزشی دستور /help",'callback_data'=>"helptext-helptext1"]],
]])]);
}
...
'reply_markup' => json_encode([
'inline_keyboard' => [
[["text"=>"🔙 بازگشت", 'callback_data' => "backaytemads"]],
]])]);
}
//###################################################################
...
//###################################################################
elseif(preg_match('/^helptext-(.*)/', $data, $match)){
$dok = $match[1];
$user['step'] = "helptext-$dok";
saveJson("melat/$userID.json",$user);
bot('editmessagetext', [
'chat_id' => $chatID,
'message_id' => $msg_id,
'text'=>"
متن راهنما را ارسال کنید 🔰
",
'parse_mode' => "html",
'reply_markup' => json_encode([
'inline_keyboard' => [
...
//###################################################################
elseif(preg_match('/^helptext-(.*)/', $step, $match)){
$user['step']= 'none';
$doke = $match[1];
Save("lib/Button/$doke.txt",$msg);
bot('sendmessage',[
...
//###################################################################
if($msg == "🔖 | تغییر پنل کاربر •" and $Tc == 'private' and in_array($chatID,$list['admins'])){
$user['step'] = "panel id";
saveJson("melat/$userID.json",$user);
bot('sendMessage', [
'chat_id' => $userID,
...
//----------------------------------------------------------------------
else if($msg == '🧑‍💻 | بخش ادمین •' and $Tc == 'private' and in_array($chatID,$list['admins'])){
...
//----------------------------------------------------------------------
elseif($msg == "📣 | تنظیمات کانال •" and $Tc == 'private' and in_array($chatID,$list['admins'])){
bot('sendmessage',[
'chat_id'=>$chatID,
'text'=>"گزینه مورد نظر را انتخاب کنید",
'reply_markup'=>json_encode([
...
'chat_id'=>$chatID,
'text'=>"
🎉 | کد هدیه به مشخصات زیر ساخته شد •

🏆 | کد = newgiftm
📍 | $money  | $msg ✓

⚡ | اگر میخواهید به کانال ارسال شود دکمه تایید رو بزنید •
",
'parse_mode'=>'MarkDown',
'reply_to_message_id'=>$msg_id,
'reply_markup'=>json_encode([
...
🔥 | تعداد = $money | $newg
➖➖➖➖➖➖➖➖➖➖➖➖
‼️ | هرکی زود کد بالا رو داخل ربات بخش کد هدیه بزنه برنده هست •
...
'chat_id' => $chatID,
'message_id' => $msg_id,
'text'=>"🎉 | کد با موفقیت به کانال ارسال شد •",
'parse_mode' => "html",
'reply_markup' => json_encode([
'inline_keyboard' => [
[["text"=>"❌ منقضی شد", 'callback_data' => "0"]],
]])]);}
elseif($msg == "💬 | بخش پیام •" and $Tc == 'private' and in_array($chatID,$list['admins'])){
bot('sendmessage',[
'chat_id'=>$chatID,
...
//////////------------------------\\\\\\\\\\\\\\///
elseif($msg == "♨️ | تنظیمات زیرمجموعه •" and $Tc == 'private' and in_array($chatID,$list['admins'])){
$datazir = json_decode(file_get_contents("lib/kodam/data-zirmjmae.json"),true);
...
//=============================================================================
elseif($msg == "⚠️ | بخش اخطار •" && $Tc == 'private' and in_array($chatID,$list['admins'])){
$user['step'] = "sendwarn";
saveJson("melat/$userID.json",$user);
bot('sendMessage', [
'chat_id' => $chatID,
...
//###################################################################
elseif($msg == "☯️ | پیگیری کاربر •" && $Tc == 'private' and in_array($chatID,$list['admins'])){
$user['step'] = "userInfo";
saveJson("melat/$userID.json",$user);
bot('sendMessage', [
'chat_id' => $chatID,
...
//###################################################################
elseif($msg == "📌 | تنظیمات لغو سفارش •" and $Tc == 'private' and in_array($chatID,$list['admins'])){
$user['step'] = 'none';
saveJson("melat/$userID.json",$user);
$data_Cancellads = json_decode(file_get_contents("lib/kodam/data-Cancellads.json"),true);
bot('sendMessage',[
...
//###################################################################
else if($msg == '♻️ | بروزرسانی •'  and $Tc == 'private' and in_array($chatID,$list['admins'])){
...
//###################################################################
elseif($msg == "❄️ | تکمیل سفارش •" and $Tc == 'private' and in_array($chatID,$list['admins'])){
$user['step'] = 'none';
saveJson("melat/$userID.json",$user);
...
if($msg == "/photoset" ){
$piclink1 = "https://t.me/testchannnells/623";
bot('sendphoto',[
 'chat_id'=>$chatID,
 'photo'=>$piclink1,
'caption' =>"نمونه عکس برای شما",
...
برای دریافت تصاویر نمونه دستور /photoset را ارسال کنید ✔",
'parse_mode' => "html",
'reply_markup' => json_encode([
'inline_keyboard' => [
[['text'=>"1️⃣",'callback_data'=>'0'],['text'=>"2️⃣",'callback_data'=>'0'],['text'=>"3️⃣",'callback_data'=>'0']],
