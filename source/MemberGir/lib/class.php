<?php
#========================================================#
if(file_exists("lib/Button/money.txt")){
    $money = file_get_contents("lib/Button/money.txt");
}else{$money = "الماس";}
//////////------------------------\\\\\\\\\\\\\\
...
if(file_exists("lib/Button/logincoin.txt")){$logincoin = file_get_contents("lib/Button/logincoin.txt");
}else{$logincoin = "10";}
...
if(file_exists("lib/Button/porsant.txt")){$porsant = file_get_contents("lib/Button/porsant.txt");
}else{$porsant = "5";}
/////////////////////////---/////
...
}else{$dokc2 = "دریافت $money $icmoney";}
