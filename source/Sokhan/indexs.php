...
$admins = array("[ADMIN]","[ADMIN]","[ADMIN]"); // شناسه مدیران
$bottag = "[BOT]"; // یوزرنیم ربات بدون@
$channel = "[CHANNEL]"; // یوزرنیم چنل بدون @
$botid = "[*[IDBOT]*]"; // شناسه ربات در ابتدای توکن
$IdCl = "LocalProGram"; // یوزرنیم چنل عکس بدون@
$IdPic = "12"; // شماره عکس داخل چنل
$fggwu = "[UUSSE]"; // یوزرنیم پشتیبانی بدون @
$cactus = "[UUSSE]"; // یوزرنیم مالک بدون @
//==========================================================//
